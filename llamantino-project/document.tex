...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{Documents}: Our implementation adopt a plain-text file collection as knowledge base for time saving. Though, this could be extended to other information source, such as PDF, web pages and databases.  
