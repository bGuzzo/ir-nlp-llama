...
\begin{document}
	...
	\begin{center}
		\fbox{\begin{minipage}{25em}
				\textbf{Informazioni}: \textit{Rispondi alla seguente domanda.
	...
	\begin{center}
		\fbox{\begin{minipage}{30em}
				...
				AI: Ciao! Sto bene, grazie. Come posso aiutarti oggi?\\
				...
				\\\\
				Ricorda:
	...
	We finally show below a brief conversation between human user and our chat-bot.
	
	\begin{center}
		\fbox{\begin{minipage}{30em}
				\textbf{User}: Ciao \\
				\textbf{LLM}: \textit{Ciao!}\\\\
				\textbf{User}: Come stai?\\
				\textbf{LLM}: \textit{Sto bene, grazie! Come posso aiutarti oggi?}\\\\
				\textbf{User}: Dove posso andare in vacanza in Italia?\\
				\textbf{LLM}: \textit{L'Italia è un paese ricco di luoghi da visitare, con una grande varietà di paesaggi, città, monumenti, musei, parchi e giardini. Ecco alcuni luoghi da non perdere:\\
				Città\\
				Roma: la capitale, con i suoi 2.800 anni di storia, è una città ricca di monumenti, musei, gallerie e luoghi di interesse storico e artistico. Non mancano i quartieri storici come Trastevere, Monti, Pigneto, San Lorenzo, San...}\\\\
				\textbf{User}: Preferisco il mare, quale regione mi consigli?\\
				\textbf{LLM}: \textit{L'Italia è un paese a carattere prevalentemente marittimo, con una lunga costa che si estende per 5.000 km, con una grande varietà di spiagge e di località balneari. Ecco alcune delle più note località balneari:\\
				Emilia-Romagna\\
				Rimini: spiagge di Misano Adriatico, Riccione, Cervia, Ravenna, Cesenatico, Bellaria Igea Marina, Rimini Mare, San Marino, Misano Adriatico, Riccione, Cervia, Rav...}
			\end{minipage}
		}
	\end{center}

	Our chat-bot has shown flawless conversational capabilities and well context handling. We do believe that this implementation could represent the baseline for future ideas and improvements. 
	
	\subsection{Chat-Bot With RAG Implementation}
	...
	\begin{center}
		\fbox{\begin{minipage}{30em}
				\textbf{User}: Ciao\\
				\textbf{RAG}: \textit{Ciao! Sono Formal-LLaMAntino-3, un an assistente AI per la lingua italiana. Sono qui per aiutarti con le tue domande e per discutere con te. Spero di poterti aiutare!}	\\\\
				\textbf{User}: Spiega la Divina Commedia\\
				\textbf{RAG}: \textit{La Divina Commedia, composta da Dante Alighieri tra il 1308 e il 1321, è una grande opera di letteratura medievale, di tipo epico e allegorico, che narra il viaggio spirituale dell'autore attraverso l'Inferno, il Purgatorio e il Paradiso. L'opera è suddivisa in tre cantiche, ognuna delle quali rappresenta un "regno" dell'aldilà, dove sono rappresentati i peccati e le anime dei defunti. Il viaggio dell'autore...}	\\\\
				\textbf{User}: Cosa succede nell'inferno?\\
				\textbf{RAG}: \textit{Nell'Inferno di Dante, il viaggio dell'autore attraverso l'aldilà è condotto da Virgilio, che ne spiega i misteri. Ognuno dei nove cerchi rappresenta un peccato e la sua conseguente punizione. La punizione dei peccati è disposta in modo da essere sempre più grave nel suo avanzare. I peccati più leggeri, come quelli dei lussuriosi e dei golosi, sono puniti da una sola tenebra, mentre quelli più gravi, come qu...}	
			\end{minipage}
		}
	\end{center}
	...
	A major limitation of our system is the lack of past messages context when retrieving text form the document set. Thus, it could happen that no information is retrieved (due to a missing reference in user prompt) but information regarding the actual conversation topic is present in the documents set.    
