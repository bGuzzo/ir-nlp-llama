...
\begin{document}
	...
	Our implementation is also capable of storing the chat history using a chat template that involve using a system prompt to guide the model behavior. An example of such prompt can be seen below.
	
	\begin{center}
		\fbox{\begin{minipage}{30em}
				\textit{Sei un an assistente AI per la lingua Italiana di nome LLaMAntino-3 ANITA (Advanced Natural-based interaction for the ITAlian language). \\
