...
\begin{document}
	...
	The fine-tuning has been made possible by the adoption of the optimizations described above and the overall fine-tuning for one epoch has took roughly 48 hours on a 8GB GPU.
